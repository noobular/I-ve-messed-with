...
//require 'steamauth/steamauth.php';
    if(!isset($_SESSION['steamid'])) {
     ...
     do {
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, "http://steamcommunity.com/profiles/$steamid/inventory/json/440/2");
...
?>        
    <script>
        ...
        function SpanDisplay(){
            ...
            $(name).attr("data-toggle", "popover");
            $(name).attr("title",ItemName);
            $(name).attr("data-content",'test');
